...
var AssocsService = (function () {
    function AssocsService(http) {
        this.http = http;
        this.API_URL_ASSOCIATIONS = 'https://staging.caritathelp.me/associations'; // URL to web API
        this.API_URL_ASSOCIATIONS_RESEARCH = 'https://staging.caritathelp.me/associations/search'; // URL to web API
        this.API_URL_SHELTER_PICTURES = 'https://staging.caritathelp.me/associations/'; // URL to pictures
    }
